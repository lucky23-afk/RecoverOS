...
The safety engine has final authority.
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print(
        "RecoverOS X - Safety Engine Test Suite"
    )
    print("=" * 70)
    ...
    for test in test_cases:
        ...
        print(
            f"Failure reason       : "
            f"{test['payment']['failure_reason']}"
        )

        print(
            f"Retry count          : "
            f"{test['payment']['retry_count']}"
        )

        print(
            f"Recovery probability : "
            f"{test['probability']:.2%}"
        )

        print(
            f"ML recommendation    : "
            f"{test['recommended_action']}"
        )
